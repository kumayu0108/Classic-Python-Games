...
score_sound = pygame.mixer.Sound(os.path.join(THIS_FOLDER,'Chrome_Dinosaur_Game_score_sound.wav'))
score_sound.set_volume(0.2)

class Dino(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.jump_sound = pygame.mixer.Sound(os.path.join(THIS_FOLDER,'Chrome_Dinosaur_Game_jump_sound.wav'))
        self.death_sound = pygame.mixer.Sound(os.path.join(THIS_FOLDER, 'Chrome_Dinosaur_Game_death_sound.wav'))
